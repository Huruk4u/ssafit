    ...
    recommendedTags.value = [
      {
        ...
        label: tagMapping[data.firstExercise] || data.firstExercise,
      },
      {
        value: user.value.secondExercise,
        label: tagMapping[data.secondExercise] || data.secondExercise,
      },
      {
        value: user.value.thirdExercise,
        label: tagMapping[data.thirdExercise] || data.thirdExercise,
      },
    ];
